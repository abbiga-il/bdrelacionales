...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-02-2026 a las 16:32:42
...
(1, 'Marcos Uribe Chavez', 'marcos.uribe24@cetis107.edu.mx', '6673257743', '2026-06-16'),
(2, 'René Berrelleza Chaidez', 'rene.berrelleza24@cetis107.edu.mx', '6672272782', '2026-11-28'),
(3, 'camila cerda caro', 'camila.cerda24@cetis107.edu.mx', '66732577467', '2026-10-04'),
(4, 'Ines Eduardo llanes cerda', 'ines.llanes@cetis107.edu.mx', '6672272799', '2026-05-14'),
(5, 'karely nissy montes vega', 'karely.montes@cetis107.edu.mx', '6670909090', '2026-02-26');
...
(1, 1, 'Danna Sofia Carrillo Quizán', 'Recepcion', 'danna.carrillo24@cetis107.edu.mx'),
(2, 3, 'Camila Anahy Beltrán Gastelum', 'Recursos humanos', 'camila.beltrang24@cetis107.edu.mx'),
(3, 2, 'Renata Soto Serrano', 'Camarera', 'renata.soto24@cetis107.edu.mx'),
(4, 1, 'Itzel Noemi Chaidez Sanchez', 'Marketin', 'itzel.chaidez24@cetis107.edu.mx'),
(5, 3, 'Marcos Daniel Valdez Montes', 'Conserje', 'marcos.valdez24@cetis107.edu.mx');
...
(1, 1, 67, 'VIP', 4000.99, 'Disponible'),
(2, 3, 41, 'sencilla', 350.22, 'Disponible'),
(3, 2, 4, 'delux', 3079.98, 'disponible'),
(4, 1, 7, 'sencilla', 450, 'ocupado'),
(5, 3, 9, 'VIP', 3008.99, 'ocupado');
...
(1, 'Hotel Francis\r\n\r\n', 'Culiacan', '667 712 4750'),
(2, 'Hotel San Marcos Grand', 'Culiacan', '667 752 0470'),
(3, 'Hotel Lucerna Culiacan', 'Culiacan', '667 759 0000');
...
(1, 3, 3, '2026-02-27', '2026-03-01', '2', 'vigente', '2026-02-18'),
(2, 4, 2, '2026-03-09', '2026-03-06', '1', 'vigente', '2026-02-18'),
(3, 5, 4, '2026-04-01', '2026-04-04', '1', 'vigente', '2026-02-18'),
(4, 1, 1, '2026-06-17', '2026-06-19', '5', 'vigente', '2026-02-18'),
(5, 2, 5, '2026-05-15', '2026-06-01', '3', 'vigente', '2026-02-18'),
(6, 3, 5, '2026-06-04', '2026-06-30', '10', 'vigente', '2026-02-18'),
(7, 4, 1, '2026-09-25', '2026-10-12', '1', 'vigente', '2026-02-18'),
(8, 5, 4, '2026-06-19', '2026-06-20', '5', 'vigente', '2026-02-18'),
(9, 1, 4, '2026-04-11', '2026-04-12', '5', 'vigente', '2026-02-18'),
(10, 2, 2, '2026-10-01', '2027-03-01', '1', 'vigente', '2026-02-18');
